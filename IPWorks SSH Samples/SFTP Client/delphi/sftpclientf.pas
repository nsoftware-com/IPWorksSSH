...
uses
  ...
  iphcore, iphtypes, iphsftpclient;
...
type
  TFormSftpclient = class(TForm)
    ...
    procedure SFTP1Transfer(Sender: TObject; Direction: Integer;
      ...
      PercentDone: Integer; Text: string; TextB: TBytes; var Cancel: Boolean);
...
procedure TFormSftpclient.ButtonConnectDisconnectClick(Sender: TObject);
begin
...
procedure TFormSftpclient.ButtonExitClick(Sender: TObject);
begin
...
procedure TFormSftpclient.ListBoxLocFilesDblClick(Sender: TOBject);
var
   Name: String;
begin
...
procedure TFormSftpclient.ListBoxRemFilesDblClick( Sender: TOBject );
var
   Name: String;
begin
   ...
   begin
      Delete(Name, 1, 7); { Remove first seven characters, '<DIR>  '}
      SFTP1.ChangeRemotePath(SFTP1.RemotePath + '/' + Name);
...
procedure TFormSftpclient.ButtonLocChgDirClick( Sender: TObject );
begin
   // Local ChgDir Button
...
procedure TFormSftpclient.ButtonLocMkDirClick(Sender: TOBject);
begin
   // Local MkDir Button
   with TFormSftpdialog.Create(self) do
   begin
...
procedure TFormSftpclient.ButtonLocRenameClick( Sender: TObject);
var
   IsDir: Boolean;
   Name: String;
begin
...
procedure TFormSftpclient.ButtonLocDeleteClick(Sender: TObject);
var
   IsDir: boolean;
   Name: string;
begin
...
procedure TFormSftpclient.ButtonRemChgDirClick( Sender: TObject );
begin
...
procedure TFormSftpclient.ButtonRemMkDirClick( Sender: TOBject );
begin
   with TFormSftpdialog.Create(self) do
   begin
      Caption := 'Make Directory';
...
procedure TFormSftpclient.ButtonRemRenameClick( Sender: TObject );
var
   Name: String;
begin
...
procedure TFormSftpclient.ButtonRemDeleteClick( Sender: TObject );
var
   Name: String;
   IsDir: Boolean;
begin
...
procedure TFormSftpclient.ButtonDownloadClick( Sender: TOBject );
var
   Name: String;
begin
...
procedure TFormSftpclient.ButtonUploadClick(Sender: TObject);
var
   Name: String;
begin
...
procedure TFormSftpclient.UpdateLocal;
var
...
procedure TFormSftpclient.UpdateButtons;
begin
...
procedure TFormSftpclient.UpdateRemote;
begin
...
procedure TFormSftpclient.UpdateNotes(note: string);
begin
...
procedure TFormSftpclient.UpdateComboBox(ComboBox: TComboBox; ItemName: String);
var
   Pos: Integer;
begin
...
procedure TFormSftpclient.ButtonLocRefreshClick( Sender: TObject );
begin
   UpdateLocal;
end;

procedure TFormSftpclient.ButtonRemRefreshClick( Sender: TOBject );
begin
   UpdateRemote;
end;

procedure TFormSftpclient.ButtonCancelClick(Sender: TObject);
begin
...
procedure TFormSftpclient.FormResize(Sender: TObject);
begin
...
procedure TFormSftpclient.ComboBoxLocHistoryChange(Sender: TObject);
begin
...
procedure TFormSftpclient.ComboBoxRemHistoryChange(Sender: TObject);
begin
...
procedure TFormSftpclient.SFTP1SSHStatus(Sender: TObject; const Message: String);
begin
  UpdateNotes(Message);
end;

procedure TFormSftpclient.SFTP1StartTransfer(Sender: TObject; Direction: Integer;
  const LocalFile, RemoteFile: string);
begin
...
procedure TFormSftpclient.SFTP1EndTransfer(Sender: TObject; Direction: Integer;
  const LocalFile, RemoteFile: string);
begin
...
procedure TFormSftpclient.SFTP1Transfer(Sender: TObject; Direction: Integer;
  const LocalFile, RemoteFile: string; BytesTransferred: Int64;
  PercentDone: Integer; Text: string; TextB: TBytes; var Cancel: Boolean);
begin
...
procedure TFormSftpclient.SFTP1DirList(Sender: TObject; const DirEntry,
  FileName: String; IsDir: Boolean; FileSize: Int64;
  const FileTime: String; IsSymlink: Boolean);
begin
...
procedure TFormSftpclient.SFTP1SSHServerAuthentication(Sender: TObject;
  HostKey: string; HostKeyB: TBytes; const Fingerprint, KeyAlgorithm, CertSubject, CertIssuer,
  Status: string; var Accept: Boolean);
begin
Accept := true;
