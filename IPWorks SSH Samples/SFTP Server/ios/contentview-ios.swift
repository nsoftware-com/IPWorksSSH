  ...
  private func startButton() -> some View {
    Button(action:
      ...
      do
      {
        ...
        {
          server.sshCert = Certificate(storeType: CertStoreTypes.cstPFXFile, store: "/Applications/IPWorks SSH 2024 macOS Edition/demos/SFTP Server/sftpserver.pfx", storePassword: "demo", subject: "*")
