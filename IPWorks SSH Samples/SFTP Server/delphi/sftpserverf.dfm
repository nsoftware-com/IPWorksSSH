object Formsftpserver: TFormsftpserver
  ...
  object iphSFTPServer1: TiphSFTPServer
    DefaultAuthMethods = 'password,publickey'
    OnConnected = iphSFTPServer1Connected
    OnConnectionRequest = iphSFTPServer1ConnectionRequest
    OnDirCreate = iphSFTPServer1DirCreate
    OnDirRemove = iphSFTPServer1DirRemove
    OnDisconnected = iphSFTPServer1Disconnected
    OnError = iphSFTPServer1Error
    OnFileClose = iphSFTPServer1FileClose
    OnFileOpen = iphSFTPServer1FileOpen
    OnFileRemove = iphSFTPServer1FileRemove
    OnSSHStatus = iphSFTPServer1SSHStatus
    OnSSHUserAuthRequest = iphSFTPServer1SSHUserAuthRequest
    Left = 600
    Top = 40
  end
end
